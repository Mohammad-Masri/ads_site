...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{url('/adminpanel')}}">لوحة التحكم</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a class="active" href="{{route('index')}}"><i class="fa fa-dashboard fa-fw"></i> الصفحة الرئيسية للموقع</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-files-o fa-fw"></i> المستخدمين<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{route('user.create')}}">أضف مستخدم جديد</a>
                            </li>
                            <li>
                                <a href="{{route('user.index')}}">استعرض المستخدمين</a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{route('post.create')}}">أضف إعلان جديد</a>
                            </li>
                            <li>
                                <a href="{{route('post.index')}}">استعرض الإعلانات</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{route('category.index')}}">استعرض جميع الأقسام</a>
                            </li>
                            <li>
                                <a href="{{route('category.create')}}">أضف قسم جديد</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
...
{{--<script src="{{asset('admin/dataTables/dataTables.bootstrap.min.js')}}"></script> -->--}}
